...
var BaseValidator = class {
  constructor({ isOptional }) {
    ...
    __publicField2(this, "fieldPaths");
    __publicField2(this, "isOptional");
    __publicField2(this, "isConvexValidator");
...
var VId = class _VId extends BaseValidator {
  ...
  constructor({
    ...
    super({ isOptional });
    __publicField2(this, "tableName");
    __publicField2(this, "kind", "id");
...
var VFloat64 = class _VFloat64 extends BaseValidator {
  constructor() {
    super(...arguments);
    __publicField2(this, "kind", "float64");
  }
  /** @internal */
  get json() {
    return { type: "number" };
...
var VInt64 = class _VInt64 extends BaseValidator {
  constructor() {
    super(...arguments);
    __publicField2(this, "kind", "int64");
  }
  /** @internal */
  get json() {
    return { type: "bigint" };
...
var VBoolean = class _VBoolean extends BaseValidator {
  constructor() {
    super(...arguments);
    __publicField2(this, "kind", "boolean");
  }
  /** @internal */
  get json() {
...
var VBytes = class _VBytes extends BaseValidator {
  constructor() {
    super(...arguments);
    __publicField2(this, "kind", "bytes");
  }
  /** @internal */
  get json() {
    return { type: this.kind };
...
var VString = class _VString extends BaseValidator {
  constructor() {
    super(...arguments);
    __publicField2(this, "kind", "string");
  }
  /** @internal */
  get json() {
    return { type: this.kind };
...
var VObject = class _VObject extends BaseValidator {
  ...
  constructor({
    ...
    __publicField2(this, "kind", "object");
...
var VLiteral = class _VLiteral extends BaseValidator {
  ...
  constructor({ isOptional, value }) {
    ...
    __publicField2(this, "kind", "literal");
...
var VArray = class _VArray extends BaseValidator {
  ...
  constructor({
    ...
    __publicField2(this, "kind", "array");
    if (element === void 0) {
...
var VRecord = class _VRecord extends BaseValidator {
  ...
  constructor({
    ...
    __publicField2(this, "value");
    __publicField2(this, "kind", "record");
    if (key === void 0) {
...
var VUnion = class _VUnion extends BaseValidator {
  ...
  constructor({ isOptional, members }) {
    super({ isOptional });
    __publicField2(this, "members");
    __publicField2(this, "kind", "union");
...
//# sourceMappingURL=chunk-3OSETJEZ.js.map
